...
class ApplicationSettingsServiceTest {
    ...
    @Mock
    com.vi.tenantservice.applicationsettingsservice.generated.ApiClient apiClient;
    ...
    public void getApplicationSettings_Should_TryResolveTenantAndCallApplicationSettingsService() {
        // when
        Mockito.when(applicationSettingsApiControllerFactory.createControllerApi()).thenReturn(applicationsettingsControllerApi);
